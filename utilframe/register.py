...
class registerFrame(tk.Frame):
    def __init__(self, parent, login):
        ...
        self.rePasswordLabel = tk.Label(self,text="Re-Enter Password")
        ...
        self.register_username = tk.Entry(self)
        self.register_email = tk.Entry(self)
        self.register_pwd = tk.Entry(self, show='*')
        self.pwd_again = tk.Entry(self, show='*')
        self.register_btn = tk.Button(self, width=15, text='Register', command=self.registerUser)
        self.return_btn = tk.Button(self, width=15, text='Return', command=self.returnLogin)
        ...
        self.usernameLabel.grid(row=0, column=0, padx=20)
        self.emailLabel.grid(row=1, column=0, padx=20)
        self.passwordLabel.grid(row=5, column=0, padx=20)
        self.rePasswordLabel.grid(row=6, column=0, padx=20)
        self.register_username.grid(row=0, column=1, padx=20)
        self.register_email.grid(row=1, column=1, padx=20)
        self.register_pwd.grid(row=5, column=1, padx=20)
        self.pwd_again.grid(row=6, column=1, padx=20)
        self.register_btn.grid(row=7, column=1, padx=20)
        self.return_btn.grid(row=7, column=0, padx=20)
    ...
    def registerUser(self):
        ...
        vaultKey = utilities.KDF(encryptionKey + password.encode() + salt, authKey + password.encode())
